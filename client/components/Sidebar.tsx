...
const Sidebar: React.FC<SidebarProps> = ({updateServer}): ReactElement => {
    ...
    <>
      <div className="flex flex-col bg-gray-300 h-full">
        ...
        <div className="mt-12 w-28 flex flex-col items-center">
          <button className="btn btn-primary flex h-12 w-12 text-5xl" onClick={(e) => addServer(e)}><i className="fa-solid fa-plus fa-2xs"></i></button>
        </div>
